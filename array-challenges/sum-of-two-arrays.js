...
function arrayPlusArray(arr1, arr2) {
  ...
  //Declare a newArr variable assigned to the concatenation of arr1 and arr2
  //Declare a val variable that is assigned the value of
  //The newArr using the reduce method which runs a reducer function on each element of the array resulting in a single output value
